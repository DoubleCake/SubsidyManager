...
from ui import FamilyManageUI,SubsidyManageUI
...
class NewWindow(MSFluentWindow):
    ...
    def __init__(self):
        ...
        self.familyInforInterface = FamilyManageUI('Family Interface', self)
        self.subManagerInterface = SubsidyManageUI("Subsidy Interface",self)
    ...
    def initNavigation(self):
        ...
        self.addSubInterface(self.familyInforInterface, FIF.APPLICATION, '家庭户管理')
        self.addSubInterface(self.subManagerInterface, FIF.VIDEO, '补贴管理')
    ...
    def initWindow(self):
        ...
        self.setWindowTitle('惠民惠农基础管理系统')
    ...
    def showMessageBox(self):
        ...
        if w.exec():
            QDesktopServices.openUrl(QUrl("https://github.com/DoubleCake/SubsidyManager"))
